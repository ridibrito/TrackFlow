...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      setSuccess(true);
      setLoading(false);
      // O router.push('/login') será chamado dentro da mensagem de sucesso
    }
  };
  ...
  const handleSocialSignup = async (provider: Provider) => {
    ...
    if (error) {
      setError('Houve um erro ao tentar criar a conta. Tente novamente.');
      setLoading(false);
    }
      ...
      <div className="space-y-6">
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-gray-50 text-gray-500">ou crie com email</span>
          </div>
        </div>
